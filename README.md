...
[Download net19 0.6.0](https://github.com/henry-xli/net19/raw/refs/heads/main/downloads/net19-0.6.0.zip) · [Privacy](PRIVACY.md) · [Architecture](docs/ARCHITECTURE.md) · [Validation](docs/VALIDATION.md)
...
- `artifacts/net19-0.6.0.zip` is the packaged build, with a SHA-256 file beside it.
