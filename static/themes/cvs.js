...
// compiled in. The same few header rules as in cvs.css are adopted into those roots (a handful of passes after load,
// no observer).
(() => {
...
.button__solid.emphasized,a.link-cta.emphasized{background-color:var(--n19-red)!important;border-color:var(--n19-red)!important;color:#fff!important;border-radius:0!important}`;
  ...
  const pass = () => { const header = document.querySelector('cvs-header, cvs-header-desktop, cvs-header-mobile'); if (header) visit(header.parentNode || document); };
