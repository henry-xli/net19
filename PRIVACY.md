...
Effective September 25, 2026. Applies to net19 0.9.0.

Net19 restyles 95 popular websites to look as they did in 2019. It has no developer-operated server, account system, analytics, advertisements, remote AI, or telemetry.
...
Net19 has access only to the 95 sites it themes (listed in `src/themes.ts`). It does not run on any other site and cannot read them.
